 ...
 * Signature: (IZ)[[I
 */
extern "C" JNIEXPORT jobjectArray JNICALL Java_com_example_sudogame_GameModel_initRandomBoard
 ...
 * Signature: ([[I)Z
 */
extern "C" JNIEXPORT jboolean JNICALL Java_com_example_sudogame_GameModel_canFindSolution
 ...
 * Signature: ([[I)[I
 */
extern "C" JNIEXPORT jintArray JNICALL Java_com_example_sudogame_GameModel_findConflictPairs
  (JNIEnv *env, jobject obj, jobjectArray board) {
    Board nativeBoard;
    if (!getBoardFromObjectArray(env, board, nativeBoard)) {
        LOGE("failed to getBoardFromObjectArray");
 ...
 * Signature: ([[I)[I
 */
extern "C" JNIEXPORT jintArray JNICALL Java_com_example_sudogame_GameModel_getOneReasonablePosition
        (JNIEnv *env, jobject obj, jobjectArray board) {
    Board nativeBoard;
    if (!getBoardFromObjectArray(env, board, nativeBoard)) {
        LOGE("failed to getBoardFromObjectArray");
